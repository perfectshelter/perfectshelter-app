...
import 'package:perfectshelter/data/cubits/utility/fetch_transactions_cubit.dart';
...
import 'package:perfectshelter/data/repositories/transaction.dart';
...
import 'package:perfectshelter/ui/screens/widgets/errors/no_internet.dart';
...
class _TransactionHistoryState extends State<TransactionHistory> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(
        title: CustomText(UiUtils.translate(context, 'transactionHistory')),
      ),
